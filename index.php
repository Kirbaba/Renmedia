    		...
    		<div class="row">
    			...
    			<div class="col-lg-4 col-md-4 col-sm-5 col-xs-12">
    				...
    				<div class="header__title">
    					<a href="#" class="header__title--logo">
    						<img src="<?php bloginfo('template_directory'); ?>/img/logo.png" alt="" />
    					</a>
    					<h2><i>Ренмедиа</i></h2>
    					<p><i>Ваша реклама в Раменском<br />на канале РЕН ТВ</i></p>
    				</div>
    				<!-- close .header__title -->
    			...
    			<!-- open .col-lg-4 col-md-4 col-sm-5 col-xs-12 -->
    			<div class="col-lg-5 col-md-5 col-sm-5 col-lg-offset-3 col-md-col-md-offset-3 col-sm-offset-2 col-xs-12">
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      <div class="modal-body">
		      ...
		      <input id="modalName" name="myModal--name" type="text" class="contacts--form--inp" placeholder="Имя"/>
		      <input id="modalPhone" name="myModal--phone" type="tel" class="contacts--form--inp" placeholder="Телефон"/>
